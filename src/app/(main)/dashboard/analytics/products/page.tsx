...
import ProductsAnalyticsPage from "./products-page";

export const metadata = { title: "Products Analytics" };
...
export default async function Page() {
  ...
  if (!session?.user) {
    const callbackUrl = encodeURIComponent("/dashboard/analytics/products");
