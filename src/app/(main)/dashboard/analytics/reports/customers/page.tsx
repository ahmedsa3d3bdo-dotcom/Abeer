...
import CustomersReportsPage from "./customers-reports-page";
...
export default async function Page() {
  ...
  if (!session?.user) {
    const callbackUrl = encodeURIComponent("/dashboard/analytics/reports/customers");
