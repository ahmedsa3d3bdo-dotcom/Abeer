    ...
    const handleExport = async (format: "pdf" | "xlsx") => {
        ...
        try {
            const config: AnalyticsExportConfig = {
                ...
                type: "marketing",
                description: "Track discount performance and campaign effectiveness",
                formats: ["pdf", "xlsx"],
                fetchData: async () => ({
                    summary: [
                        { label: "Total Discounts", value: data.summary.totalDiscounts, format: "number", color: "purple" },
                        { label: "Active Now", value: data.summary.activeDiscounts, format: "number", color: "emerald" },
                        { label: "Total Uses", value: data.summary.totalUses, format: "number", color: "amber" },
                        { label: "Total Savings", value: data.summary.totalSavings, format: "currency", color: "blue" },
                        { label: "Avg per Order", value: data.summary.averageDiscountPerOrder, format: "currency", color: "pink" },
                    ],
                    charts: [],
                tables: [
                    {
                        ...
                        columns: [
                            ...
                            { header: "Uses", key: "uses", format: "number", align: "right", width: 15 },
                            { header: "Savings", key: "savings", format: "currency", align: "right", width: 20 },
                        ],
                        data: data.discountUsageOverTime.map((d) => ({
                    ...
                    {
                        title: "Top Performing Discounts",
                        columns: [
                            { header: "Discount", key: "name", width: 30 },
                            { header: "Type", key: "type", width: 18 },
                            { header: "Uses", key: "uses", format: "number", align: "center", width: 12 },
                            { header: "Savings", key: "savings", format: "currency", align: "right", width: 18 },
                            { header: "Status", key: "status", width: 12 },
                        ],
                        data: data.topDiscounts,
                    },
                    {
                        ...
                        columns: [
                            ...
                            { header: "Total Savings", key: "savings", format: "currency", align: "right", width: 25 },
                        ],
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
                ...
                <Card>
                    <CardContent className="p-5">
                        <div className="flex flex-col gap-3">
                            <div className="p-2 rounded-lg bg-pink-500/10 w-fit">
            ...
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            ...
                            onClick={async () => {
                                try {
                                    await exportChartAsPNG("marketing-usage-chart", "discount-usage-over-time");
                ...
                <CardContent>
                    <div id="marketing-usage-chart" className="h-[300px]">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {data.topDiscounts.map((discount) => {
                                ...
                                return (
                                    <TableRow key={`discount-row-${discount.id}`}>
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                <div
            ...
            <div className="grid gap-4 lg:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    try {
                                        await exportChartAsPNG("marketing-type-chart", "discounts-by-type");
                                        toast.success("Chart exported successfully");
                                    } catch (error) {
                                        toast.error("Failed to export chart");
                                    }
                    ...
                    <CardContent>
                        <div id="marketing-type-chart" className="h-[280px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <PieChart>
                                    <Pie
                                        data={data.discountsByType}
                                        ...
                                        label={({ type, percent }) => {
                                            ...
                                            return `${TYPE_LABELS[type] || type}: ${pct}%`;
                                        }}
                                        labelLine={false}
                                    >
                                        {data.discountsByType.map((entry, index) => (
                                            <Cell
                                                key={`discount-type-${entry.type}-${index}`}
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    try {
                                        await exportChartAsPNG("marketing-savings-chart", "savings-by-type");
                                        toast.success("Chart exported successfully");
                                    } catch (error) {
                                        toast.error("Failed to export chart");
                                    }
                    ...
                    <CardContent>
                        <div id="marketing-savings-chart" className="h-[280px]">
                            <ResponsiveContainer width="100%" height="100%">
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {data.recentCampaigns.map((campaign) => {
                                    ...
                                    return (
                                        <TableRow key={`campaign-row-${campaign.id}`}>
