...
export function OverviewCards() {
  return (
    <div className="grid grid-cols-1 gap-4 *:data-[slot=card]:shadow-xs sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
      ...
      <Card>
        <CardHeader>
          <div className="w-fit rounded-lg bg-emerald-600 p-2">
      ...
      <Card>
        <CardHeader>
          <div className="w-fit rounded-lg bg-rose-600 p-2">
            <BadgeDollarSign className="size-5 text-white" />
          </div>
        </CardHeader>
        <CardContent className="flex size-full flex-col justify-between">
          <div className="space-y-1.5">
      ...
      <Card className="col-span-1 xl:col-span-2">
        ...
        <CardFooter>
          <p className="text-muted-foreground text-sm">Growth since last year</p>
        </CardFooter>
      </Card>
    </div>
  );
